...
import {DataTableRowActions} from "@/app/components/ui/data-table-row-actions"
...
export const financeColumnsGranted = (uid: string): ColumnDef<FinanceDTO>[] => [
  ...financeColumns,
  {
    id: "actions",
    cell: ({row}) => {
      return (
        <div className="min-w-fit text-right md:ml-0 md:px-8">
          <DataTableRowActions data={{...row.original}} uid={uid} />
        </div>
      )
    },
  },
