...
import {CreateEditHealth} from "@/types/domain/health-types"
import {FormSubmitClientButton as FormSubmitButton} from "@/app/components/forms/form-submit-button"
import {Input} from "@/app/components/ui/input"
import {cn} from "@/app/utils"
import {format} from "date-fns"
import {fr} from "date-fns/locale"
import {getHealthCategories} from "@/utils/constants"
import {toast} from "sonner"
import {useForm} from "react-hook-form"
import {useRouter} from "next/navigation"
import {zodResolver} from "@hookform/resolvers/zod"
import {createEditHealthFormSchema} from "@/app/components/forms/form-validators/health-form-schema"

type FormAddHealthProps = {
  health?: CreateEditHealth
  onClose: () => void
  uid: string
}
          ...
          render={({field}) => (
            <FormItem>
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
                  {getHealthCategories().map((category) => (
