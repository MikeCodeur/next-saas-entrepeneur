...
// NOW : Form validation = service validation
// Mike : Here implement the custom FORM validation schema

export const createEditFinanceFormSchema = z.object({
  id: z.string().optional(),
  userId: z.string().optional(), // Mike : userId is required FOR SERVICE not for FORM
  date: z.coerce.date(),
