...
import {createQueryParam} from '@/lib/utils'
import {useRouter} from 'next/navigation'
import {paramPage, paramPageSize} from '@/utils/constants'
...
export function DataTablePagination<TData>({
  ...
  const gotoPage = (page: number) => {
    const url = createQueryParam(paramPage, page)
    router.push(url.href)
  }
  const changePageSize = (pageSize: number) => {
    const url = createQueryParam(paramPageSize, pageSize)
    router.push(url.href)
  }
  return (
